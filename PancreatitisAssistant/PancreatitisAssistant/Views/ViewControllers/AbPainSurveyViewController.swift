...
class AbPainSurveyViewController: OCKInstructionsTaskViewController, ORKTaskViewControllerDelegate {
    ...
    override func taskView(_ taskView: UIView & OCKTaskDisplayable, didCompleteEvent isComplete: Bool, at indexPath: IndexPath, sender: Any?) {
        //UIView.appearance().tintColor = UIColor(#colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1))
        //self.taskView.tintColor = UIColor(#colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1))
       ...
       // let surveyTask = ORKOrderedTask(identifier: "survey", steps: [painStep])
        ...
        //surveyViewController.view.backgroundColor = UIColor(#colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1))
        //surveyViewController.view.tintColor = UIColor(#colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1))
